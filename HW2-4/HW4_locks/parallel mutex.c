/*Answear for Part 3:
Retrieving an item from the hash table does not require lock.
Since there is no write action, order of accessing different parts of
retrieving function does not impact the outcome.
*/ 
